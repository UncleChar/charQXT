...
- (void)setAlignment:(RWDropdownMenuCellAlignment)alignment
{
    ...
    switch (_alignment) {
        case RWDropdownMenuCellAlignmentLeft:
            ...
            self.imageView.frame = CGRectMake( 10,7.5, 29, 29);
            self.textLabel.frame = CGRectMake(50, 2, kScreenWidth - 60, 40);

            break;
        case RWDropdownMenuCellAlignmentRight:
            
            self.textLabel.textAlignment = NSTextAlignmentRight;
            self.imageView.frame = CGRectMake(kScreenWidth - 40, 7.5, 29, 29);
            self.textLabel.frame = CGRectMake(0, 2, kScreenWidth - 50, 40);
