...
- (void)creatTopToolBar:(NSArray *)titles
{
    ...
    for (int i = 0; i < titles.count; i++) {
        ...
        [button setTitleColor:[ConfigUITools colorWithR:0 G:140 B:240 A:1] forState:UIControlStateSelected];
    ...
    CGFloat selectLineX = (_tmpBtn.frame.size.width - selectLineW) / 2;
    CGFloat selectLineY = CGRectGetMaxY(line.frame) - selectLineH + 0.5;
    _selectLine = [[UIView alloc] init];
    _selectLine.backgroundColor = [ConfigUITools colorWithR:0 G:140 B:240 A:1];
...
- (void)btnAction:(RemoveBtnHighlighted *)button
{
    ...
    [UIView animateWithDuration:.35 animations:^{
        _selectLine.center = CGPointMake(button.center.x, CGRectGetMaxY(button.frame)+3);
